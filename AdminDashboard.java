    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        giftpack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent giftpackadmindashboardIntent = new Intent(AdminDashboard.this, com.warmdelightapp.GiftpacksAdmin.class);
        ...
        giftpack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent admindashboardIntent = new Intent(AdminDashboard.this, GiftpacksAdmin.class);
